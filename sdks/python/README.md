# browsers-sdk
A client library for accessing Morph Browsers Service

## Usage
First, create a client:

```python
from browsers_sdk import Client
...
```python
from browsers_sdk import AuthenticatedClient
...
```python
from browsers_sdk.models import MyDataModel
from browsers_sdk.api.my_tag import get_my_data_model
from browsers_sdk.types import Response
...
1. Any endpoint which did not have a tag will be in `browsers_sdk.api.default`
